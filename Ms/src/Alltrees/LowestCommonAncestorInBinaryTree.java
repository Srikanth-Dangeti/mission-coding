...
public class LowestCommonAncestorInBinaryTree {
    ...
    Node findLCA(Node node, int n1, int n2) 
    {
        ...
        if (left_lca!=null && right_lca!=null) {
        	//System.out.println("left_lca.data= "+ left_lca.data);
            //System.out.println("right_lca.data= "+ right_lca.data);
        	return node;
        }
        
		/*
		 * if(left_lca!=null) { System.out.println("left_lca.data= "+left_lca.data); }
