...
public class MergeTwoBSTToSortedList {
	
	// Root of BST
    Node root;
 
    // Constructor
    MergeTwoBSTToSortedList() {
        root = null;
    }
...
// Utility function for inorder traversal of the tree
    ...
    public static void main (String[] args)
    {
        ...
        */
        ...
        MergeTwoBSTToSortedList tree1 = new MergeTwoBSTToSortedList();
        ...
        */
        ...
        MergeTwoBSTToSortedList tree2 = new MergeTwoBSTToSortedList();
        tree2.root = new Node(80);   
        tree2.root.left = new Node(40);
        tree2.root.right = new Node(120);
             
             
        MergeTwoBSTToSortedList tree = new MergeTwoBSTToSortedList();   
